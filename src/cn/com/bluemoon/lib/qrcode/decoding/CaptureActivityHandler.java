...
private static final int RESTART_PREVIEW = 8;

private static final int DECODE_FAILED = 2;

private static final int RETURN_SCAN_RESULT = 9;

private static final int LAUNCH_PRODUCT_QUERY = 6;

private static final int DECODE_SUCCEEDED = 3;
  ...
  public void handleMessage(Message message) {
    switch (message.what) {
      case AUTO_FOCUS:
        ...
        if (state == State.PREVIEW&&CameraManager.get()!=null) {
