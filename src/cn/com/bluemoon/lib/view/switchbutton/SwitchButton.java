package cn.com.bluemoon.lib.view.switchbutton;
...
// TODO: lk 2016/6/16 源链接 https://github.com/kyleduo/SwitchButton，由于使用的是api23编译，在此处直接引用会编译错误，故直接抄过来
...
public class SwitchButton extends CompoundButton {
    ...
    public void setBackColorRes(int backColorRes) {
        // TODO: lk 2016/6/16 原为（下同）：
//        ContextCompat.getColorStateList(getContext(), thumbColorRes) v4-23.0
