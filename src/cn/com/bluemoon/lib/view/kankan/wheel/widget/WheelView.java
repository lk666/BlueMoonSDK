...
package cn.com.bluemoon.lib.view.kankan.wheel.widget;
...
public class WheelView extends View {
    ...
    private Drawable wheelBackgroundDrawable = null;
     ...
     * @param resource
     */
    public void setWheelBackgroundDrawable(Drawable resource) {
        wheelBackgroundDrawable = resource;
    ...
    private void initResourcesIfNecessary() {
        ...
        if (wheelBackgroundDrawable != null)
            setBackgroundDrawable(wheelBackgroundDrawable);
        else
            setBackgroundResource(wheelBackground);
    }
