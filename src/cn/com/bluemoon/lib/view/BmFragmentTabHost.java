/** 
 * Description: Reference android.support.v4.app.FragmentTabHost source
...
public class BmFragmentTabHost extends TabHost implements
	...
	public BmFragmentTabHost(Context context) {
	...
	public BmFragmentTabHost(Context context, AttributeSet attrs) {
		super(context, attrs);
