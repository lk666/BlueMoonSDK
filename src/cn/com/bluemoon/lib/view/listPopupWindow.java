...
public class listPopupWindow extends PopupWindow {
	...
	public listPopupWindow(Context context, String bpCode, String bpName, String communityCode, ChooseDateListener listener) {
	...
	public listPopupWindow(Context context, ChooseDateListener listener) {
		this.mContext = context;
		this.listener = listener;
		init(null);
	}
