...
public class LibImageUtil {
	 ...
	 * @param requestCode 请求code,在result中接收
	 */
	public static void cropPhoto(Activity act,Uri uri,int aspectX,int aspectY,int  outputX,int outputY,int requestCode) {
	 ...
	 * @param requestCode 请求code,在result中接收
	 */
	public static void cropPhoto(Fragment fragment,Uri uri,int aspectX,int aspectY,int  outputX,int outputY,int requestCode) {
